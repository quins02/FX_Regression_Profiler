...
plt.subplot(2,1,2)
plt.scatter(BF1[:,0],BF1[:,1])
plt.scatter(BF2[:,0],BF2[:,1])
plt.scatter(BF3[:,0],BF3[:,1])
plt.scatter(BF4[:,0],BF4[:,1])
plt.scatter(BF5[:,0],BF5[:,1])
plt.scatter(BF6[:,0],BF6[:,1])
plt.scatter(BF7[:,0],BF7[:,1])
plt.scatter(BF8[:,0],BF8[:,1])
plt.scatter(BF9[:,0],BF9[:,1])
plt.scatter(BF10[:,0],BF10[:,1])
plt.scatter(BF11[:,0],BF11[:,1])
plt.scatter(BF12[:,0],BF12[:,1])
plt.xlabel('FX Rate')
plt.ylabel('Exotic Value ($)')
plt.title('Value')
plt.grid(True)
